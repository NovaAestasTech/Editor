...
import { Loader2, Sparkles, PanelRightOpen, PanelRightClose, Moon, Sun } from "lucide-react";
...
const Tiptap = ({ aiToken }: { aiToken: string }) => {
  ...
  const inlineBtnHover = darkMode ? "hover:bg-white/10" : "hover:bg-neutral-100";
  ...
  const summaryBorder = darkMode ? "rgba(255,255,255,0.08)" : "rgba(0,0,0,0.08)";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Left — Document name */}
          <span className={`text-sm font-semibold tracking-tight whitespace-nowrap mr-3 ${textPrimary}`}
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{ borderColor: summaryBorder, transition: "border-color 0.4s ease" }}
              >
                <Sparkles
                  className="w-4 h-4"
                  style={{ color: "#a78bfa" }}
              ...
              <div className="flex-1 overflow-y-auto scrollbar-hide px-4 py-3">
                {isSummarizing ? (
                  ...
                  <div className={`flex flex-col items-center justify-center h-full text-center px-2 ${textMuted}`}>
